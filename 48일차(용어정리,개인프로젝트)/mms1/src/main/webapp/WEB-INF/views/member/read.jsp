			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<br>						
						<h6 style="line-height: 25%">☞ <span style="color:red">다른 아이디/사이트에서 사용한 적 없는 비밀번호</span></h6>
						<br>
						<h6 style="line-height: 25%">☞ <span style="color:red">이전에 사용한 적 없는 비밀번호</span>가 안전합니다.</h6>
						<br>
						...
						<div class="form-group row">							
							<div class="col-sm-10">
								<input type="password" class="form-control" id="npw" name="npw" placeholder="새 비밀번호">
							</div>
						</div>
						
						<div class="form-group row">							
							<div class="col-sm-10">
								<input type="password" class="form-control" id="npw2" placeholder="새 비밀번호 확인">
							</div>
						</div>
					</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#mymodal2").on("click", "button[data-dismiss='modal']", function() {
			defaultPwInput();
		});
